...
/**
 * Màn chính dashboard — ghép các phần từ các folder con:
 * Sidebar + Topbar + OverviewStats + ProjectSummary
 * + OverallProgress + TodayTask + ProjectsWorkload.
 */
    ...
    <div className="dash-screen">
      ...
      <div className="dash-content">
        ...
        <div className="dash-grid">
          ...
          <Card title="Overall Progress" className="dash-grid__progress" action={<select className="dash-select" defaultValue="all" aria-label="Lọc tiến độ"><option value="all">All</option></select>}>
            <OverallProgress />
          </Card>
          ...
          <Card title="Projects Workload" className="dash-grid__workload" action={<select className="dash-select" defaultValue="3" aria-label="Khoảng workload"><option value="3">Last 3 months</option><option value="6">Last 6 months</option></select>}>
            <ProjectsWorkload />
          </Card>
        </div>
      </div>
